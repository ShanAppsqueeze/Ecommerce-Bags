        ...
        <div className="max-w-4xl mx-auto px-4 py-16 sm:py-24 text-center">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 max-w-2xl mx-auto mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="text-left">
                <h2 className="text-lg font-semibold mb-2">Your order is confirmed</h2>
                <p className="text-gray-600 dark:text-gray-300">
                  We've received your order and will begin processing it shortly. 
                  You'll receive a WhatsApp message with order details and updates.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
              <svg className="h-8 w-8 text-blue-500 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
              <svg className="h-8 w-8 text-green-500 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
              <h3 className="font-semibold mb-1">WhatsApp Updates</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                You'll receive order updates via WhatsApp on your provided number
              </p>
            </div>

            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
              <svg className="h-8 w-8 text-purple-500 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-12 text-sm text-gray-500 dark:text-gray-400">
            <p>Need help? <Link href="/contact" className="text-blue-500 hover:underline">Contact our support team</Link></p>
            <p className="mt-2">You'll be automatically redirected to homepage in 10 seconds...</p>
          </div>
        </div>
      </div>
      <Footer />
